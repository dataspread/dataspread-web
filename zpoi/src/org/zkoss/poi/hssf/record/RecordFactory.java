...
public final class RecordFactory {
	...
	private static final Class<? extends Record>[] recordClasses = new Class[] {
		...
		Compat12Record.class, //ZSS-746
		CompressPicturesRecord.class, //ZSS-746
		...
		FontRecord.class,
		FooterRecord.class,
		ForceFullCalculationRecord.class, //ZSS-746
		FormatRecord.class,
		FormulaRecord.class,
		FrameRecord.class,
		GridsetRecord.class,
		...
		MMSRecord.class,
		MTRSettingsRecord.class, //ZSS-746
