...
public final class WindowOneRecord extends StandardRecord {
    ...
    public String toString()
    {
        ...
        buffer.append("    .h_hold          = ")
            .append(HexDump.shortToHex(getHorizontalHold())).append("\n");
        buffer.append("    .v_hold          = ")
            .append(HexDump.shortToHex(getVerticalHold())).append("\n");
        buffer.append("    .width           = ")
            .append(HexDump.shortToHex(getWidth())).append("\n");
        ...
        buffer.append("    .activeSheet     = ")
            .append(HexDump.intToHex(getActiveSheetIndex())).append("\n");
        buffer.append("    .firstVisibleTab = ")
            .append(HexDump.intToHex(getFirstVisibleTab())).append("\n");
        buffer.append("    .numselectedtabs = ")
            .append(HexDump.shortToHex(getNumSelectedTabs())).append("\n");
        buffer.append("    .tabwidthratio   = ")
            .append(HexDump.shortToHex(getTabWidthRatio())).append("\n");
        buffer.append("[/WINDOW1]\n");
