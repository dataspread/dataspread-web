...
public final class TableStylesRecord extends StandardRecord {
	...
	//ZSS-746
	public TableStylesRecord(int rt, int grbitFrt, int cts, String defListStyle, String defPivotStyle) {
		this.rt = rt;
		this.grbitFrt = grbitFrt;
		this.cts = cts;
		this.rgchDefListStyle = defListStyle;
		this.rgchDefPivotStyle = defPivotStyle;
	}
