...
public final class FontRecord extends StandardRecord {
	...
	private static final BitField fCondense = BitFieldFactory.getInstance(0x40); 
	private static final BitField fExtend    = BitFieldFactory.getInstance(0x80); 
	...
	public String toString() {
		...
		sb.append("       .condensed  = ").append(isCondensed()).append("\n");
		sb.append("       .extended   = ").append(isExtended()).append("\n");
		...
		sb.append("    .unused3       = ").append(HexDump.byteToHex(field_9_zero)).append("\n");
	...
	public void serialize(LittleEndianOutput out) {
		...
		//20140812, henrichen@zkoss.org: always use unicode
		boolean hasMultibyte = true;
//		boolean hasMultibyte = StringUtil.hasMultibyte(field_11_font_name);
	...
	protected int getDataSize() {
		int size = 16; // 5 shorts + 4 bytes + cch(1byte) + fHighByte(1byte)
		int fontNameLen = field_11_font_name.length();
		if (fontNameLen < 1) {
			return size;
		}
...
//		boolean hasMultibyte = StringUtil.hasMultibyte(field_11_font_name);
	 ...
	 * @since 3.9.5
	 */
	public void setCondensed(boolean flag) {
		field_2_attributes = fCondense.setShortBoolean(field_2_attributes, flag);
	}
	...
	public void setExtended(boolean flag) {
		field_2_attributes = fExtend.setShortBoolean(field_2_attributes, flag);
	}
	...
	public boolean isCondensed(){
		return fCondense.isSet(field_2_attributes);
	}
	...
	public boolean isExtended(){
		return fExtend.isSet(field_2_attributes);
	}

	//ZSS-746
	public FontRecord(int height, int attr, int palette, int bold, 
		int superscript, int under, int family, int charset, String fontname) {
		field_1_font_height         = (short) height;
		field_2_attributes          = (short) attr;
		field_3_color_palette_index = (short) palette;
		field_4_bold_weight         = (short) bold;
		field_5_super_sub_script    = (short) superscript;
		field_6_underline           = (byte) under;
		field_7_family              = (byte) family;
		field_8_charset             = (byte) charset;
		field_11_font_name          = fontname;
	}
