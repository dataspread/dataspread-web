    ...
    extends StandardRecord
{
    ...
    static final private BitField _adtl_diag                 = //_diag_border_palette_idx
        BitFieldFactory.getInstance(0x001fc000);
    static final private BitField _adtl_diag_line_style      = //_border_diagonal
        BitFieldFactory.getInstance(0x01e00000);

    // bit 25(fHasXFExt) whether exists a XFExt
    static final private BitField _has_xfext			      =
            BitFieldFactory.getInstance(0x02000000);
    ...
    public void setAdtlPaletteOptions(int options) //ZSS-746, set whole value
    {
    ...
    public void setHasXFExt(boolean flag) {
    	field_8_adtl_palette_options =
                _has_xfext.setBoolean(field_8_adtl_palette_options, flag);
    }
    
    public boolean isHasXFExt() {
        return _has_xfext.getValue(field_8_adtl_palette_options) == 1;
    }
    ...
    public String toString()
    {
        ...
        buffer.append("[XF or EXTENDEDFORMAT]\n");
        ...
        buffer.append("    .fontindex       = ")
            .append(HexDump.shortToHex(getFontIndex())).append("\n");
        buffer.append("    .formatindex     = ")
            .append(HexDump.shortToHex(getFormatIndex())).append("\n");
        buffer.append("    .celloptions     = ")
            .append(HexDump.shortToHex(getCellOptions())).append("\n");
        buffer.append("          .islocked  = ").append(isLocked())
            .append("\n");
        buffer.append("          .ishidden  = ").append(isHidden())
            .append("\n");
        buffer.append("          .recordtype= ")
            .append(HexDump.shortToHex(getXFType())).append("\n");
        buffer.append("          .parentidx = ")
            .append(HexDump.shortToHex(getParentIndex())).append("\n");
        buffer.append("    .alignmentoptions= ")
            .append(HexDump.shortToHex(getAlignmentOptions())).append("\n");
        buffer.append("          .alignment = ").append(getAlignment())
            .append("\n");
        buffer.append("          .wraptext  = ").append(getWrapText())
            .append("\n");
        buffer.append("          .valignment= ")
            .append(HexDump.shortToHex(getVerticalAlignment())).append("\n");
        buffer.append("          .justlast  = ")
            .append(HexDump.shortToHex(getJustifyLast())).append("\n");
        buffer.append("          .rotation  = ")
            .append(HexDump.shortToHex(getRotation())).append("\n");
        buffer.append("    .indentionoptions= ")
            .append(HexDump.shortToHex(getIndentionOptions())).append("\n");
        buffer.append("          .indent    = ")
            .append(HexDump.shortToHex(getIndent())).append("\n");
        buffer.append("          .shrinktoft= ").append(getShrinkToFit())
            .append("\n");
        buffer.append("          .mergecells= ").append(getMergeCells())
            .append("\n");
        buffer.append("          .readngordr= ")
            .append(HexDump.shortToHex(getReadingOrder())).append("\n");
        ...
        buffer.append("    .borderoptns     = ")
            .append(HexDump.shortToHex(getBorderOptions())).append("\n");
        buffer.append("          .lftln     = ")
            .append(HexDump.shortToHex(getBorderLeft())).append("\n");
        buffer.append("          .rgtln     = ")
            .append(HexDump.shortToHex(getBorderRight())).append("\n");
        buffer.append("          .topln     = ")
            .append(HexDump.shortToHex(getBorderTop())).append("\n");
        buffer.append("          .btmln     = ")
            .append(HexDump.shortToHex(getBorderBottom())).append("\n");
        buffer.append("    .paleteoptns     = ")
            .append(HexDump.shortToHex(getPaletteOptions())).append("\n");
        buffer.append("          .leftborder= ")
            .append(HexDump.shortToHex(getLeftBorderPaletteIdx()))
            .append("\n");
        buffer.append("          .rghtborder= ")
            .append(HexDump.shortToHex(getRightBorderPaletteIdx()))
            .append("\n");
        buffer.append("          .diag      = ")
            .append(HexDump.shortToHex(getDiag())).append("\n");
        buffer.append("    .paleteoptn2     = ")
            .append(HexDump.intToHex(getAdtlPaletteOptions()))
            .append("\n");
        buffer.append("          .topborder = ")
            .append(HexDump.shortToHex(getTopBorderPaletteIdx()))
            .append("\n");
        buffer.append("          .botmborder= ")
            .append(HexDump.shortToHex(getBottomBorderPaletteIdx()))
            .append("\n");
        buffer.append("          .adtldiag  = ")
            .append(HexDump.shortToHex(getAdtlDiag())).append("\n");
        buffer.append("          .diaglnstyl= ")
            .append(HexDump.shortToHex(getAdtlDiagLineStyle())).append("\n");
        buffer.append("          .fillpattrn= ")
            .append(HexDump.shortToHex(getAdtlFillPattern())).append("\n");
        buffer.append("    .fillpaloptn     = ")
            .append(HexDump.shortToHex(getFillPaletteOptions()))
            .append("\n");
        buffer.append("          .foreground= ")
            .append(HexDump.shortToHex(getFillForeground())).append("\n");
        buffer.append("          .background= ")
            .append(HexDump.shortToHex(getFillBackground())).append("\n");
        buffer.append("[/XF or EXTENDEDFORMAT]\n");
