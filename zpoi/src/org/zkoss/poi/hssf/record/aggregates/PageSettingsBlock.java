...
public final class PageSettingsBlock extends RecordAggregate {
     ...
     */
    private static final short PAPER_SIZE = 9;
    private static final short SCALE = 100;
    private static final short PAGE_START = 1;
    private static final short FIT_WIDTH = 1;
    private static final short FIT_HEIGHT = 1;
    private static final short OPTIONS = 0;
    private static final short HORZ_RESOLUTION = 300;
    private static final short VERT_RESOLUTION = 300;
    private static final double FOOTER_MARGIN =  0.5;
    private static final double HEADER_MARGIN = 0.5;
    private static final short COPIES = 1;
    
    private static PrintSetupRecord createPrintSetup() {
        PrintSetupRecord retval = new PrintSetupRecord();

        retval.setPaperSize(PAPER_SIZE);
        retval.setScale(SCALE);
        retval.setPageStart(PAGE_START);
        retval.setFitWidth(FIT_WIDTH);
        retval.setFitHeight(FIT_HEIGHT);
        retval.setOptions(OPTIONS);
        retval.setHResolution(HORZ_RESOLUTION);
        retval.setVResolution(VERT_RESOLUTION);
        retval.setHeaderMargin(HEADER_MARGIN);
        retval.setFooterMargin(FOOTER_MARGIN);
    ...
    //ZSS-765
    private HeaderFooterRecord getOrCreateHeaderFooterRecord() {
    	if (_headerFooter == null) {
    		_headerFooter = new HeaderFooterRecord();
    	}
    ...
    public boolean isDiffOddEven() {
    	return _headerFooter != null && _headerFooter.isDiffOddEven();
    }
    public void setDiffOddEven(boolean flag) {
    	getOrCreateHeaderFooterRecord().setDiffOddEven(flag);
    }
    ...
    public boolean isDiffFirst() {
    	return _headerFooter != null && _headerFooter.isDiffFirst();
    }
    public void setDiffFirst(boolean flag) {
    	getOrCreateHeaderFooterRecord().setDiffFirst(flag); 
    }
    ...
    public boolean isScaleWithDoc() {
    	return _headerFooter != null && _headerFooter.isScaleWithDoc();
    }
    public void setScaleWithDoc(boolean flag) {
    	getOrCreateHeaderFooterRecord().setScaleWithDoc(flag);
    }
    ...
    public boolean isAlignMargins() {
    	return _headerFooter != null && _headerFooter.isAlignMargins();
    }
    public void setAlignMargins(boolean flag) {
    	getOrCreateHeaderFooterRecord().setAlignMargins(flag);
    }
    ...
    public String getEvenHeader() {
    	return _headerFooter == null ? "" : _headerFooter.getHeaderEven();
    }
    public void setEvenHeader(String str) {
    	getOrCreateHeaderFooterRecord().setHeaderEven(str);
    }
    ...
    public String getEvenFooter() {
    	return _headerFooter == null ? "" : _headerFooter.getFooterEven();
    }
    public void setEvenFooter(String str) {
    	getOrCreateHeaderFooterRecord().setFooterEven(str);
    }
    ...
    public String getFirstHeader() {
    	return _headerFooter == null ? "" : _headerFooter.getHeaderFirst();
    }
    public void setFirstHeader(String str) {
    	getOrCreateHeaderFooterRecord().setHeaderFirst(str);
    }
    ...
    public String getFirstFooter() {
    	return _headerFooter == null ? "" : _headerFooter.getFooterFirst();
    }
    public void setFirstFooter(String str) {
    	getOrCreateHeaderFooterRecord().setFooterFirst(str);
    }
}
