 ...
 */
public final class HSSFFirstFooter extends HeaderFooter implements Footer {
	private final PageSettingsBlock _psb;

	protected HSSFFirstFooter(PageSettingsBlock psb) {
		_psb = psb;
	}

	protected String getRawText() {
		return _psb.getFirstFooter();
	}

	@Override
	protected void setHeaderFooterText(String text) {
		_psb.setFirstFooter(text);
	}
}
