...
public class HSSFSheet implements org.zkoss.poi.ss.usermodel.Sheet {
    ...
    HSSFSheet cloneSheet(HSSFWorkbook workbook) {
        ...
        return workbook.createHSSFSheet(workbook,sheet._sheet.cloneSheet());
    }
    ...
    private void setRepeatingRowsAndColumns(
        ...
        short externSheetIndex =
                _workbook.getWorkbook().checkExternSheet(sheetIndex,sheetIndex);
    ...
    public SheetProtection getOrCreateSheetProtection() {
    	final FeatHdrRecord record = _sheet.getOrCreateEnhancedProtectionRecord();
    	return record == null ? //ZKPVT-78: check null 
    			null : new HSSFSheetProtection(record.getEnhancedProtection());
    }

    //20140421, henrichen@zkoss.org, ZSS-576: set hashed password
    public void setPasswordHash(short hashpass) {
    	getProtectionBlock().setPasswordHash(hashpass);
    }
	...
	//20140917, henrichen@zkoss.org, ZSS-765, since 3.9.5
    @Override
	public boolean isDiffOddEven() {
		return _sheet.getPageSettings().isDiffOddEven();
	}
	//20140917, henrichen@zkoss.org, ZSS-765, since 3.9.5
    @Override
	public void setDiffOddEven(boolean flag) {
		_sheet.getPageSettings().setDiffOddEven(flag);
	}
	//20140917, henrichen@zkoss.org, ZSS-765, since 3.9.5
    @Override
	public boolean isDiffFirst() {
		return _sheet.getPageSettings().isDiffFirst();
	}
	//20140917, henrichen@zkoss.org, ZSS-765, since 3.9.5
    @Override
	public void setDiffFirst(boolean flag) {
		_sheet.getPageSettings().setDiffFirst(flag);
	}
	//20140917, henrichen@zkoss.org, ZSS-765, since 3.9.5
    @Override
	public boolean isScaleWithDoc() {
		return _sheet.getPageSettings().isScaleWithDoc();
	}
	//20140917, henrichen@zkoss.org, ZSS-765, since 3.9.5
    @Override
	public void setScalWithDoc(boolean flag) {
		_sheet.getPageSettings().setScaleWithDoc(flag);
	}
	//20140917, henrichen@zkoss.org, ZSS-765, since 3.9.5
    @Override
	public boolean isAlignMargins() {
		return _sheet.getPageSettings().isAlignMargins();
	}
	//20140917, henrichen@zkoss.org, ZSS-765, since 3.9.5
    @Override
	public void setAlignMargins(boolean flag) {
		_sheet.getPageSettings().setAlignMargins(flag);
	}
	//20140917, henrichen@zkoss.org, ZSS-765, since 3.9.5
    @Override
	public Header getEvenHeader() {
		return new HSSFEvenHeader(_sheet.getPageSettings());
	}
	//20140917, henrichen@zkoss.org, ZSS-765, since 3.9.5
    @Override
	public Footer getEvenFooter() {
		return new HSSFEvenFooter(_sheet.getPageSettings());
	}
	//20140917, henrichen@zkoss.org, ZSS-765, since 3.9.5
    @Override
	public Header getFirstHeader() {
		return new HSSFFirstHeader(_sheet.getPageSettings());
	}
	//20140917, henrichen@zkoss.org, ZSS-765, since 3.9.5
    @Override
	public Footer getFirstFooter() {
		return new HSSFFirstFooter(_sheet.getPageSettings());
     ...
     *
     * @param newPrintHeadings boolean to turn on or off the printing of
     *                          headings
     * @since 3.9.5
     */
    public void setPrintHeadings(boolean newPrintHeadings) {
        getSheet().getPrintHeaders().setPrintHeaders(newPrintHeadings);
    }
