...
public final class NumberToTextConverter {
	...
	/*package*/ static final long EXCEL_NAN_BITS = 0xFFFF0420003C0000L;
	...
	/*package*/ static int countSignifantDigits(String sb) {
	...
	/*package*/ static void appendExp(StringBuilder sb, int val) {
		if(val < 10) {
			sb.append('0');
