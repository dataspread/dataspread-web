...
public interface Cell {
    ...
    /**
     * Old Excel spec(Used in old XLS Excel). Because we want to 
     * load cached formula result; we have to honer this flag; or we could 
     * read in incorrect cached results! (ZSS-873: issue/book/492-movesheet.xls)
     * @return true if need calcOnLoad for the cell.
     * @since 3.9.6
     */
