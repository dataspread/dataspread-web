...
public class DateUtil {
    ...
    // 20140702, henrichen@zkoss.org, ZSS-379 for other locale, it is possible to be AM/PM hh:mm:ss
    private static final Pattern time_ptrn_locale = Pattern.compile("^[ampAMP/]*[mhHsS :]*$");
    ...
    public static boolean isADateFormat(int formatIndex, String formatString) {
        ...
        if (!r){
        	// 20140702, henrichen@zkoss.org, ZSS-375 for other locale, it is possible to be AM/PM hh:mm:ss
        	r = time_ptrn_locale.matcher(fs).matches();
        }
        return r;
    }
