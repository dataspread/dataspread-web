...
public interface FormulaEvaluator {
    ...
    *  calling evaluateFormulaCell on each one.
    ...
    CellValue evaluateFormula(int sheetIndex, String formula, Object ref);
    //20111128, henrichen@zkoss.org: given formula, sheet index, evaluate the formula results
    ValueEval evaluateFormulaValueEval(int sheetIndex, String formula, boolean ignoreDereference, Object ref);
