 ...
 * @since 3.5.0
 */
public class DependencyTableImplV3 extends DependencyTableAdv {
	private static final long serialVersionUID = 1L;
	private static final Log _logger = Log.lookup(DependencyTableImplV3.class.getName());
	...
	public void add(Ref dependant, Ref precedent) {
		if (precedent.getType()==RefType.CELL || precedent.getType()==RefType.AREA)
	...
	public void merge(DependencyTableAdv dependencyTable) {
		if (!(dependencyTable instanceof DependencyTableImplV3)) {
			// just in case
		...
		DependencyTableImplV3 another = (DependencyTableImplV3) dependencyTable;
