...
//		}
    ...
    public static void setBorder(SBook book, CellStyleHolder holder, String color, BorderType linestyle) {
        setBorder(book, holder, color, linestyle, BORDER_EDGE_ALL);
    }

    public static void setBorderTop(SBook book, CellStyleHolder holder, String color, BorderType linestyle) {
        setBorder(book, holder, color, linestyle, BORDER_EDGE_TOP);
    }

    public static void setBorderLeft(SBook book, CellStyleHolder holder, String color, BorderType linestyle) {
        setBorder(book, holder, color, linestyle, BORDER_EDGE_LEFT);
    }

    public static void setBorderBottom(SBook book, CellStyleHolder holder, String color, BorderType linestyle) {
        setBorder(book, holder, color, linestyle, BORDER_EDGE_BOTTOM);
    }

    public static void setBorderRight(SBook book, CellStyleHolder holder, String color, BorderType linestyle) {
        setBorder(book, holder, color, linestyle, BORDER_EDGE_RIGHT);
    }

    public static void setBorder(SBook book, CellStyleHolder holder, String htmlColor, BorderType lineStyle, short at) {

        final SCellStyle orgStyle = holder.getCellStyle();
        //ZSS-464 try to search existed matched style
        SCellStyle style = null;
        final SColor color = book.createColor(htmlColor);
        boolean hasBorder = lineStyle != BorderType.NONE;
        if (htmlColor != null) {
            CellStyleMatcher matcher = new CellStyleMatcher(orgStyle);
...
//	}
    ...
    public static SCellStyle getFillStyle(SCellStyle cellStyle, SCellStyle tbStyle) {
        return cellStyle.getFillPattern() != FillPattern.NONE ?
                cellStyle : tbStyle;
    }
    ...
    public static SCellStyle prepareStyle(SCell srcCell) {
        ...
        SFont font = StyleUtilNoDB.getFontStyle(book, cellStyle, tbStyle);
